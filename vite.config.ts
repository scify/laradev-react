...
export default defineConfig(({ mode, command }) => {
	// Load main .env file (Vite's built-in function)
	...
	let additionalEnv = {};
	// Only load additional .env file if APP_DEVELOPMENT_ENV is set
	if (mainEnv.APP_DEVELOPMENT_ENV && mainEnv.APP_DEVELOPMENT_ENV.length > 1) {
